...
-too many connnections!!                                                            ---> problem with intevallo
-issues displaying a decent desired t and freezing when server returns error 406    ---> error management and reset waiting
...
float desiredT = 27;// desired room temperature
